...
class STRINGS:
    REPLY_TO_MEDIA = 'lmao reply to a photo or media dumb bitch'
    THESE_MEDIA_TYPES_ONLY = 'BITCH NO! only <b>photo</b>, <b>sticker</b> and <b>document</b> media types are allowed.'
    GIF_NOT_SUPPORTED = 'uhhh, you really cant reverse a gif rn.'
    DOWNLOADING_MEDIA = 'wait for few secs am searching'
    UPLOADING_MEDIA = 'omw uploading it'
