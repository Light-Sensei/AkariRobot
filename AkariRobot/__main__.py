...
from AkariRobot.modules import ALL_MODULES
from AkariRobot.modules.helper_funcs.chat_status import is_user_admin
from AkariRobot.modules.helper_funcs.misc import paginate_modules
...
PHOTO = (
      "https://telegra.ph/file/7ef542475e2b5962144d1.mp4",
      "https://telegra.ph/file/ebda5bd6fd2951c829d05.mp4",
      "https://telegra.ph/file/6a0055bbe6c568ad45ddc.mp4",
)

buttons = [
    [
        InlineKeyboardButton(text="♡ ᴀᴅᴅ ᴍᴇ ♡", url="t.me/AkariWatanabeXRoBot?startgroup=new"),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AkariRobot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("[♡♡ やあ Kon'ichiwa Minna-San, Am Akari Watanabe and I'll protect you from everything ♡♡](https://telegra.ph/file/3b48e1fb99a6dc4cbf018.jpg)",
reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ᴍᴏʀᴇ ɪɴғᴏ", callback_data="Shikimori_back"),
                        ],
                    ]
                ),
...
def Shikimori_about_callback(update, context):
    ...
    if query.data == "Shikimori_":
        query.message.edit_text(
            text="♡ Hoi I'm *Akari Watanabe*, a powerful group management bot built to help you manage your group easily. ♡"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ", url="t.me/SHIKIMORIXsupport"),
...
def about_admin(update, context):
  ...
  *♡ Let's make your group bit effective now ♡*
  ...
  Congragulations, Akari Robot now ready to manage your group.
...
def about_credits(update, context):
    ...
    if query.data == "about_credits":
        query.message.edit_text(
            text="""  
  *♡ Credits for Akari Watanabe ♡ *

  Here Developers Making And Give Inspiration For Made The Shikimori Robot""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                        InlineKeyboardButton(text="Light Yagami (夜神月)", url="https://t.me/yagami_kun"),
                 ],
                 [
                    InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="Shikimori_back")
                 ]
...
reply_markup=InlineKeyboardMarkup(
    ...
    grp_start_handler = CallbackQueryHandler(
        PM_START_TEXT, pattern=r"Shikimori_Info", run_async=True
    )    
    ...
    dispatcher.add_handler(grp_start_handler)
